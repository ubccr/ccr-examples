...
##
#SBATCH --constraint="[A16|A40|A100|GH200|H100|V100]"
##
###############################################################################
...
##       To use P4000 GPUs (with 8192 MiB of GPU RAM) change this script to 
##       request at least 3 GPUs
##
##SBATCH --constraint="[A2|A40|A100|H100|P4000|T4|V100]"
##
###############################################################################

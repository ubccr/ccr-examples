...
apptainer run \
 ...
 gmx pdb2gmx -f 1AKI_clean.pdb -o 1AKI_processed.gro -water tip3p -ff charmm36-jul2022

## This generated three files:
...
## http://www.mdtutorials.com/ and move to an "inputs" direcory
curl -L -sS -o "ions.mdp" "http://www.mdtutorials.com/gmx/lysozyme/Files/ions.mdp"
mkdir -p "inputs"
mv ions.mdp ./inputs/
...
## Download the input parameter file "minim.mdp" and move to the inputs directory
curl -L -sS -o "minim.mdp" "http://www.mdtutorials.com/gmx/lysozyme/Files/minim.mdp"
mv minim.mdp ./inputs/
...
## Download the .mdp file for this example and move to the inputs directory
curl -L -sS -o "nvt.mdp" "http://www.mdtutorials.com/gmx/lysozyme/Files/nvt.mdp"
mv nvt.mdp ./inputs/
...
# Download the 500-ps NPT equilibration .mdp file "npt.mdp" and to the inputs directory
curl -L -sS -o "npt.mdp" "http://www.mdtutorials.com/gmx/lysozyme/Files/npt.mdp"
mv npt.mdp ./inputs/
...
## http://www.mdtutorials.com/ and move the file to an "inputs" direcory
curl -L -sS -o "md.mdp" "http://www.mdtutorials.com/gmx/lysozyme/Files/md.mdp"
mv md.mdp ./inputs/

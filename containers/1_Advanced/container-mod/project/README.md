...
BIND_PATH="/vscratch/grp-[YourGroupName]:/vscratch/grp-[YourGroupName],/projects/academic/[YourGroupName]:/projects/academic/[YourGroupName]"
```
...
```
Initializing...
'abaqus-2024.sif' not found in application info database.
